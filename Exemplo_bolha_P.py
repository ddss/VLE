...
exemplo = VLE('PontoBolha_P',Componentes,model_liq,model_vap,z=[0.3703,1-0.3703],Temp=313.15,Pressao=1.013,estphi=[1.0,1.0],estBeta = 0.5,tolAlg=1e-10,toleq=1e-4,maxiter=500,z_coordenacao=10.0)
exemplo.run()
...
Graficos('Pxy',Componentes, exemplo.Composicao_x1,exemplo.Pressao_Ponto_Bolha, exemplo.Pressao_Ponto_Orvalho, x_experimentais = comp ,y_experimentais = P, y_incertezas = yerr, T = 313.15 )
